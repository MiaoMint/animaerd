...
func (e TagEdges) ArtworksOrErr() ([]*Artwork, error) {
	if e.loadedTypes[0] {
...
func (*Tag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tag.FieldName, tag.FieldType:
...
// QueryArtworks queries the "artworks" edge of the Tag entity.
func (t *Tag) QueryArtworks() *ArtworkQuery {
	return NewTagClient(t.config).QueryArtworks(t)
}
